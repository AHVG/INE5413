...
def main():
    ...
    coloracao_minima = Coloracao().lawler(grafo)
    cromaticos_por_vertice = Coloracao().definir_cromatico_por_vertice(grafo, coloracao_minima)
    print(f"Coloração mínima : {coloracao_minima}")
